---
name: feishu-飞书-api-docs
description: |
  Search Feishu/Lark (飞书) API documentation. 4,070+ docs covering server API, event subscriptions, and mini programs. Powered by SpecFusion.
