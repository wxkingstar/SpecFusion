...
description: |
  ...
  67,000+ API docs across 20 Chinese open platforms with full-text search. 搜索20个开放平台的API开发文档，支持中文全文检索。
...
user-invocable: true
argument-hint: "企业微信发送消息 / feishu 审批 / 淘宝商品发布 / 小红书订单 / 抖音电商订单 / 微信小程序登录 / 微信小店订单 / 拼多多订单 / 有赞交易 / 微信支付JSAPI下单 / 支付宝当面付 / 京东商品API / SHEIN商品发布 / 得物订单 / 火山引擎ECS创建实例 / 百炼千问API / 泛微免登获取accessToken / 北森查询组织单元 / 搜索关键词"
...
|------|-----------|---------|---------|
| 企业微信 | wecom | ~2,800 | 服务端 API、客户端 API、应用开发 |
| 飞书 | feishu | ~4,280 | 服务端 API、事件订阅、小程序 |
| 钉钉 | dingtalk | ~3,610 | 服务端 API、客户端 JSAPI、事件订阅、开发指南、连接平台、AI PaaS、互动卡片、专属版插件、硬件接入等 |
| 淘宝开放平台 | taobao | ~7,020 | 商品、交易、物流、店铺、用户等 API |
| 小红书 | xiaohongshu | ~110 | 电商开放平台 API（订单、商品、售后、物流等） |
| 抖音电商开放平台 | douyin | ~1,440 | 商品、订单、物流、售后、精选联盟、即时零售等 API |
...
| 拼多多开放平台 | pinduoduo | ~290 | 订单、商品、物流、售后、营销、店铺、虚拟类目、多多进宝等 API |
| 有赞开放平台 | youzan | ~1,250 | 用户、会员、商品、交易、物流、营销、店铺、分销、财务、美业等 API |
| 微信支付 | wechat-pay | ~560 | JSAPI/APP/H5/Native/小程序支付、退款、分账、合单支付、代金券、商家转账等 API |
| 支付宝开放平台 | alipay | ~600 | 当面付、APP支付、手机网站支付、电脑网站支付、资金、会员、营销、安全等 API |
| 京东商家开放平台 | jd | ~5,450 | 商品、订单、售后、营销会员、门店、财务、供应链、秒送、政企、广告、京东健康、拍拍、物流等 API |
| SHEIN开放平台 | shein | ~260 | 密钥授权、商品、订单、退货退款、采购单、库存、财务、物流、Webhook 等 API |
| 得物开放平台 | dewu | ~270 | 商品、订单、售后、出价、入仓、开票、文件、对账单等 API |
| 火山引擎云服务器 | volcengine-ecs | ~121 | 实例、镜像、密钥对、安全组、地域、部署集、专有宿主机、云助手、补丁管理等 API |
| 火山引擎文档中心 | volcengine | ~35,170 | 181 个云产品文档：计算、AI、网络、存储、数据库、容器、安全、CDN、视频云、大数据等 |
| 阿里云百炼 | bailian | ~1,880 | 千问大模型、DashScope SDK、OpenAI兼容接口、语音合成/识别、图像/视频生成、应用开发等 |
| 泛微 e-teams 开放平台 | weaver | ~560 | 认证免登、组织架构、人员、工作流程、业务表单、任务、考勤、CRM、订单、文档、日程等 API |
| 北森 iTalent 开放平台 | beisen | ~1,090 | 招聘、组织员工、假勤、薪酬、绩效、目标、学习云、干部管理、360评估、PaaS 平台等 API |
